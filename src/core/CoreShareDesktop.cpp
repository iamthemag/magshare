...
//
// $Id: CoreShareDesktop.cpp 1560 2023-03-15 07:56:27Z mastroddi $
//
//////////////////////////////////////////////////////////////////////
...
bool Core::startShareDesktop( VNumber user_id )
{
  ...
  {
    sHtmlMsg = tr( "%1 You cannot share desktop with %2." ).arg( IconManager::instance().toHtml( "desktop-share-refused.png", "*G*" ), Bee::userNameToShow( u, true ) );
  ...
  sHtmlMsg = tr( "%1 You start to share desktop with %2." ).arg( IconManager::instance().toHtml( "desktop-share.png", "*G*" ), Bee::userNameToShow( u, true ) );
  dispatchSystemMessage( ID_DEFAULT_CHAT, user_id, sHtmlMsg, DispatchToAllChatsWithUser, ChatMessage::System, false );
...
void Core::stopShareDesktop( VNumber user_id )
{
  ...
  if( u.isValid() )
  {
    QString sHtmlMsg = tr( "%1 You stop to share desktop with %2." ).arg( IconManager::instance().toHtml( "desktop-share-refused.png", "*G*" ), Bee::userNameToShow( u, true ) );
