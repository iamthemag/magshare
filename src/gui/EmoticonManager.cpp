...
//
// $Id: EmoticonManager.cpp 1562 2023-03-20 16:17:34Z mastroddi $
//
//////////////////////////////////////////////////////////////////////
...
#else
  text_stream_in.setEncoding( QStringConverter::Utf8 );
#endif
  while( !text_stream_in.atEnd() )
  {
    emoji_line = text_stream_in.readLine();
    emoji_parts = emoji_line.split( "\t", Qt::SkipEmptyParts );
...
#else
  text_stream_out.setEncoding( QStringConverter::Utf8 );
#endif
