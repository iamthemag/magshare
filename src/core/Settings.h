...
//
// $Id: Settings.h 1371 2024-04-20 09:16:57Z mastroddi $
//
//////////////////////////////////////////////////////////////////////

#ifndef MAGSHARE_SETTINGS_H
#define MAGSHARE_SETTINGS_H
...
public:
  ...
  inline bool disableSendFolder() const;
  ...
  inline void setDisableTabInEditBox( bool );
  inline bool disableTabInEditBox() const;
...
inline int Settings::userRecognitionMethod() const { return userRecognitionUsesDefaultMethod() ? RecognizeByAccountAndDomain : m_userRecognitionMethod; }
...
inline QString Settings::defaultChatName() const { return QString( "* MagShare Chat *" ); }
...
inline bool Settings::disableSendFolder() const { return m_disableSendFolder; }
...
inline void Settings::setDisableTabInEditBox( bool new_value ) { m_disableTabInEditBox = new_value; }
inline bool Settings::disableTabInEditBox() const { return m_disableTabInEditBox; }


#endif // MAGSHARE_SETTINGS_
