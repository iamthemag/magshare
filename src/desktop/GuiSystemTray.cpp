...
//
// $Id: GuiSystemTray.cpp 1566 2023-03-26 08:40:31Z mastroddi $
//
//////////////////////////////////////////////////////////////////////
...
void GuiSystemTray::setDefaultIcon()
{
  if( m_iconStatus != GuiSystemTray::Default )
  {
    ...
    setIcon( IconManager::instance().icon( "magshare-tray.png" ) );

#else
  setIcon( IconManager::instance().icon( "magshare.png" ) );
#endif
...
void GuiSystemTray::setMessageIcon()
{
  ...
  {
#if defined( Q_OS_UNIX ) && !defined( Q_OS_MACOS )
    setIcon( IconManager::instance().icon( "magshare-message-tray.png" ) );
#else
    setIcon( IconManager::instance().icon( "magshare-message.png" ) );
#endif
...
void GuiSystemTray::showMessageInTray( const QString& msg, bool long_time )
{
  if( Settings::instance().showNotificationOnTray() && Settings::instance().trayMessageTimeout() > 0 )
  {
    ...
    showMessage( msg, Settings::instance().programName(), IconManager::instance().icon( "magshare-message.png" ), show_time );
  }
}
