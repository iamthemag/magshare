...
#
# $Id: macx_deploy_bundle.sh 1555 2023-02-13 13:47:31Z mastroddi $
#
######################################################################

BEEBEEP_VERSION=5.8.6

echo "Making MagShare Bundle version ${BEEBEEP_VERSION}"
...
hdiutil create -volname "MagShare ${BEEBEEP_VERSION}" -srcfolder macosx_dmg -ov -format UDZO beebeep-${BEEBEEP_VERSION}.dmg
