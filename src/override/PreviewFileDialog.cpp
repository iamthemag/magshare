...
//
// $Id: PreviewFileDialog.cpp 1562 2023-03-20 16:17:34Z mastroddi $
//
//////////////////////////////////////////////////////////////////////
  ...
  : QFileDialog( parent, caption, directory, filter )
{
  ...
  m_defaultPixmap = Bee::convertToGrayScale( QIcon( ":images/magshare.png" ).pixmap( Settings::instance().previewFileDialogImageSize(), Settings::instance().previewFileDialogImageSize() ) );
  setPixmapInPreview( m_defaultPixmap );

  {
    QGridLayout *layout = (QGridLayout*)this->layout();
    layout->addWidget( mp_preview, 0, layout->columnCount()+1, layout->rowCount()-1, 1, Qt::AlignLeft );
  }
