...
//
// $Id: GuiScreenShot.cpp 1562 2023-03-20 16:17:34Z mastroddi $
//
//////////////////////////////////////////////////////////////////////
...
void GuiScreenShot::resizeEvent( QResizeEvent* )
{
  if( !m_screenShot.isNull() )
  {
    ...
    QPixmap pix = mp_labelScreenShot->pixmap( Qt::ReturnByValue );
    if( scaled_size != pix.size() )
      updateScreenShot();
  }
}
...
void GuiScreenShot::captureScreen()
{
  ...
  double device_pixel_ratio = qApp->devicePixelRatio();
