...
const char MAGSHARE_LANGUAGE_WEBSITE[] = "";
const char MAGSHARE_NEWS_WEBSITE[] = "https://iamthemag.github.io/magshare/news.html";
const char MAGSHARE_CHECK_VERSION_WEBSITE[] = "";
const char MAGSHARE_LAST_VERSION_FILE[] = "/releases/latest/download/VERSION.json";
const char MAGSHARE_FACT_WEBSITE[] = "";
const char MAGSHARE_TIPS_WEBSITE[] = "";
const char MAGSHARE_FAQ_WEBSITE[] = "";
