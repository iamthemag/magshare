...
//
// $Id: GuiHome.cpp 1562 2023-03-20 16:17:34Z mastroddi $
//
//////////////////////////////////////////////////////////////////////
...
void GuiHome::setNews( const QString& news )
{
  ...
  if( news.isEmpty() )
  {
    mp_lNews->setText( QString( "<a style='text-decoration: none;' href='%1'><b>%2</b></a>" )
                         ...
                         .arg( Bee::beeColorsToHtmlText( "M  a  g  S  h  a  r  e" ) ) );
    tooltip_text = tr( "Click here to see the latest news about MagShare project" );
  }
  else
  {
