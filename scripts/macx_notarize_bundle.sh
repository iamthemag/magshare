...
#
# $Id: macx_notarize_bundle.sh 1536 2021-12-24 09:30:01Z mastroddi $
#
######################################################################
...
xcrun altool --notarize-app --primary-bundle-id "net.beebeep.app" --username "marco.mastroddi@gmail.com" --password "@keychain:MagShare_DEV_PW" --file $dmg_file &> $response_tmp_file
echo "Done."
...
while true; do
  ...
  xcrun altool --notarization-info "$uuid" --username "marco.mastroddi@gmail.com" --password "@keychain:MagShare_DEV_PW" &> $response_tmp_file
