...
//
// $Id: Avatar.cpp 1562 2023-03-20 16:17:34Z mastroddi $
//
//////////////////////////////////////////////////////////////////////
...
bool Avatar::create()
{
  ...
  QStringList sl_name = converted_name.simplified().split( " ", Qt::SkipEmptyParts );
  if( sl_name.isEmpty() )
    sl_name << "x" << "x";
  ...
  while( fm.horizontalAdvance( text_to_write ) > w_max_size )
  {
  ...
  int border_x = (m_size.width() - fm.horizontalAdvance( text_to_write )) / 2;
